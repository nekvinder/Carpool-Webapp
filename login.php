                                            ...
                                            <form id="main-contact-form" class="contact-form" name="contact-form" method="post" action="login.php">
                                                <div class="col-sm-8 col-sm-offset-1">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="uname" class="form-control" value="test" required="required">
                                                    </div>
                                                    <div class="form-group">
                                                        <label>Password *</br></label>
                                                        <input type="password" value="test1234" name="password" class="form-control" required="required">
                                                    </div>
                                                    <div class="form group">
